...
public class IndiceCajaBean extends PadreBean {

	public IndiceCajaBean() {
		subexpediente=lineaNegocio=mes=anio=totalHojas=integradorExpedientes=revisorExpedientes=aprobadorExpedientes=recibioRevisoExpediente=recepcionExpedientes=new String();
	}
